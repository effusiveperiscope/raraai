...
class FeatureDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        phones = phones[phones != self.cfg.model.space_id] # Do not align space token
...
class FeatureCollator:
    ...
    def __call__(self, batch):
        ...
        phones_padded = pad_sequence(phones_list, batch_first=True, padding_value=self.config.model.pad_id)  # [B, T2_max]
